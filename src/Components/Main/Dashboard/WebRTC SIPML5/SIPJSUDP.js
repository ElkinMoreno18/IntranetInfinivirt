...
// import { Session, UA } from './src/index.js'
...
//         if (ingressSession && ingressSession.status !== Session.C.STATUS_TERMINATED) {
...
//     if (egressSession && egressSession.status !== Session.C.STATUS_TERMINATED) {
//       // if not already terminated, send a bye
//       egressSession.bye()
//     }
